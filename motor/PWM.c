...
{
     PWMClockSet( module, number);
     PWMDiv( div);
     PWMPinConfigure( module, number);
     PWMGenDisable( module, number);
     PWMGenConfigure( module,  mode,  number);
     PWMGenPeriodSet( module,  number,  div,  Clock_Required);
     PWMDutyCycleSet( module,  number,  mode,  duty_cycle);
     PWMGenEnable( module, number);
